...
public class ProductCategoryResourceIntTest {
     ...
     *
     * @see com.poseidon.repository.search.ProductCategorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getLevelOne()).isEqualTo(DEFAULT_LEVEL_ONE);
        assertThat(testProductCategory.getLevelTwo()).isEqualTo(DEFAULT_LEVEL_TWO);
        assertThat(testProductCategory.getLevelThree()).isEqualTo(DEFAULT_LEVEL_THREE);
    ...
    public void updateProductCategory() throws Exception {
        ...
        ProductCategory testProductCategory = productCategoryList.get(productCategoryList.size() - 1);
        assertThat(testProductCategory.getLevelOne()).isEqualTo(UPDATED_LEVEL_ONE);
        assertThat(testProductCategory.getLevelTwo()).isEqualTo(UPDATED_LEVEL_TWO);
        assertThat(testProductCategory.getLevelThree()).isEqualTo(UPDATED_LEVEL_THREE);
