  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="poseidonApiGatewayApp.company.detail.title">Company</Translate> [<b>{companyEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{companyEntity.userLogin ? companyEntity.userLogin : ''}</dd>
          </dl>
