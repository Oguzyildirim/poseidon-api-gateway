    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="poseidonApiGatewayApp.company.home.createOrEditLabel">
              <Translate contentKey="poseidonApiGatewayApp.company.home.createOrEditLabel">Create or edit a Company</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : companyEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="poseidonApiGatewayApp.company.name">Name</Translate>
                  </Label>
                  <AvField
                    id="company-name"
                    type="text"
                ...
                <AvGroup>
                  <Label id="emailLabel" for="email">
                    <Translate contentKey="poseidonApiGatewayApp.company.email">Email</Translate>
                  </Label>
                  <AvField
                    id="company-email"
                    type="text"
                ...
                <AvGroup>
                  <Label id="phoneLabel" for="phone">
                    <Translate contentKey="poseidonApiGatewayApp.company.phone">Phone</Translate>
                  </Label>
                  <AvField
                    id="company-phone"
                    type="text"
                ...
                <AvGroup>
                  <Label id="cityLabel" for="city">
                    <Translate contentKey="poseidonApiGatewayApp.company.city">City</Translate>
                  </Label>
                  <AvField id="company-city" type="text" name="city" />
                </AvGroup>
                <AvGroup>
                  <Label id="countryLabel" for="country">
                    <Translate contentKey="poseidonApiGatewayApp.company.country">Country</Translate>
                  </Label>
                  <AvField id="company-country" type="text" name="country" />
                </AvGroup>
                <AvGroup>
                  <Label for="user.login">
                    <Translate contentKey="poseidonApiGatewayApp.company.user">User</Translate>
                  </Label>
                  <AvInput id="company-user" type="select" className="form-control" name="userId">
                    {users
