  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="poseidonApiGatewayApp.productCategory.delete.question">
          <Translate contentKey="poseidonApiGatewayApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
