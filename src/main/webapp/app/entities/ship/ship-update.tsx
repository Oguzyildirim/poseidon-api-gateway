    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="apigatewayApp.ship.home.createOrEditLabel">
              <Translate contentKey="apigatewayApp.ship.home.createOrEditLabel">Create or edit a Ship</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : shipEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  >
                    <option value="MALE">
                      <Translate contentKey="apigatewayApp.Gender.MALE" />
                    </option>
                    <option value="FEMALE">
                      <Translate contentKey="apigatewayApp.Gender.FEMALE" />
                    </option>
                    <option value="OTHER">
                      <Translate contentKey="apigatewayApp.Gender.OTHER" />
                    </option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvInput
                    ...
                    className="form-control"
                    name="user.id"
                    value={isNew ? users[0] && users[0].id : shipEntity.user.id}
                  >
                    {users
                ...
                <AvGroup>
                  ...
                  <AvInput
                    ...
                    className="form-control"
                    name="company.id"
                    value={isNew ? companies[0] && companies[0].id : shipEntity.company.id}
                  >
                    {companies
