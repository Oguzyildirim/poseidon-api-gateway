    ...
    return (
      <div>
        <h2 id="order-item-heading">
          <Translate contentKey="apigatewayApp.orderItem.home.title">Order Items</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="apigatewayApp.orderItem.home.createLabel">Create new Order Item</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('quantity')}>
                  <Translate contentKey="apigatewayApp.orderItem.quantity">Quantity</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="apigatewayApp.orderItem.order">Order</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
