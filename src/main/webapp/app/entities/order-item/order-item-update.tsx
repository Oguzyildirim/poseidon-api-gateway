    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="poseidonApiGatewayApp.orderItem.home.createOrEditLabel">
              <Translate contentKey="poseidonApiGatewayApp.orderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : orderItemEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="product.partNo">
                    <Translate contentKey="poseidonApiGatewayApp.orderItem.product">Product</Translate>
                  </Label>
                  <AvInput id="order-item-product" type="select" className="form-control" name="productId">
                    {products
