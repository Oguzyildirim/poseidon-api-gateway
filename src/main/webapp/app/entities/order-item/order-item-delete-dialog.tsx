  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="poseidonApiGatewayApp.orderItem.delete.question">
          <Translate contentKey="poseidonApiGatewayApp.orderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
