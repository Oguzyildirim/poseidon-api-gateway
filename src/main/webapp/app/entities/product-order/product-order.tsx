    ...
    return (
      <div>
        <h2 id="product-order-heading">
          <Translate contentKey="apigatewayApp.productOrder.home.title">Product Orders</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="apigatewayApp.productOrder.home.createLabel">Create new Product Order</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('placedDate')}>
                  <Translate contentKey="apigatewayApp.productOrder.placedDate">Placed Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('status')}>
                  <Translate contentKey="apigatewayApp.productOrder.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('code')}>
                  <Translate contentKey="apigatewayApp.productOrder.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="apigatewayApp.productOrder.ship">Ship</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {productOrderList.map((productOrder, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`apigatewayApp.OrderStatus.${productOrder.status}`} />
                  </td>
                  <td>{productOrder.code}</td>
                  <td>{productOrder.ship ? <Link to={`ship/${productOrder.ship.id}`}>{productOrder.ship.email}</Link> : ''}</td>
