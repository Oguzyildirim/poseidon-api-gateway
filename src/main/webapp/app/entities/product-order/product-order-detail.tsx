  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="poseidonApiGatewayApp.productOrder.detail.title">ProductOrder</Translate> [<b>{productOrderEntity.id}</b>
            ]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{productOrderEntity.shipEmail ? productOrderEntity.shipEmail : ''}</dd>
          </dl>
