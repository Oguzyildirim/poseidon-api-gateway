  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="apigatewayApp.productOrder.detail.title">ProductOrder</Translate> [<b>{productOrderEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{productOrderEntity.ship ? productOrderEntity.ship.email : ''}</dd>
          </dl>
