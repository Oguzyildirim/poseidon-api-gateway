    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="poseidonApiGatewayApp.productOrder.home.createOrEditLabel">
              <Translate contentKey="poseidonApiGatewayApp.productOrder.home.createOrEditLabel">Create or edit a ProductOrder</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : productOrderEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="statusLabel">
                    <Translate contentKey="poseidonApiGatewayApp.productOrder.status">Status</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="COMPLETED">
                      <Translate contentKey="poseidonApiGatewayApp.OrderStatus.COMPLETED" />
                    </option>
                    <option value="PENDING">
                      <Translate contentKey="poseidonApiGatewayApp.OrderStatus.PENDING" />
                    </option>
                    <option value="CANCELLED">
                      <Translate contentKey="poseidonApiGatewayApp.OrderStatus.CANCELLED" />
                    </option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label id="codeLabel" for="code">
                    <Translate contentKey="poseidonApiGatewayApp.productOrder.code">Code</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label for="ship.email">
                    <Translate contentKey="poseidonApiGatewayApp.productOrder.ship">Ship</Translate>
                  </Label>
                  <AvInput id="product-order-ship" type="select" className="form-control" name="shipId">
                    {ships
