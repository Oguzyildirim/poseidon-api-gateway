  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="poseidonApiGatewayApp.product.delete.question">
          <Translate contentKey="poseidonApiGatewayApp.product.delete.question" interpolate={{ id: productEntity.id }}>
